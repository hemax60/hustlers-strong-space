...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hustlers Health & Fitness, Adajan — a modern, premium gym in Surat built to help you transform your body and life. Train strong, stay consistent." },
      { name: "author", content: "Hustlers Health & Fitness" },
      { property: "og:title", content: "Hustlers Health & Fitness — Premium Gym in Adajan, Surat" },
      { property: "og:description", content: "Hustlers Health & Fitness, Adajan — a modern, premium gym in Surat built to help you transform your body and life. Train strong, stay consistent." },
